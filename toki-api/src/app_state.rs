...
use crate::{
    ...
    config::{AgentSettings, KleerSettings},
    domain::{
    ...
    repositories::{
        AgentRunRepositoryImpl, NotificationRepositoryImpl, PushSubscriptionRepositoryImpl,
        RepoRepositoryImpl, UserRepositoryImpl,
    },
};
...
pub struct AppState {
    ...
    pub agent_run_repo: Arc<AgentRunRepositoryImpl>,
...
impl AppState {
    ...
    pub async fn new(
        ...
        Self {
            ...
            agent_run_repo: Arc::new(AgentRunRepositoryImpl::new(db_pool.clone())),
